...
// Ambil Data Faktur Harga berdasarkan id
...
<?php else: ?>
<?php if (!empty($data)): ?>
<h1 class="fs-5 mb-4">Ubah Faktur Harga</h1>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control form-control-sm" id="no_faktur" name="no_faktur"
                  value="<?= $data['no_faktur'] ?>" readonly required>
                <div class="invalid-feedback">
...
$(document).ready(function() {
  ...
  $(document).on('click', '.remove-btn', function() {
    var idDetailPenawaran = $(this).closest('.main-tr').find('input[name="id_detail_faktur[]"]').val();
  ...
  $(document).on('input', '.qty, .price', function() {
    ...
    var idDetailPenawaran = row.find('input[name="id_detail_faktur[]"]').val(); // Dapatkan ID detail
