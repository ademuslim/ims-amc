...
if (isset($_GET['id']) && $_GET['id'] !== '') {
  ...
  if (!empty($data_pesanan_pembelian)) {
    $data = $data_pesanan_pembelian[0]; // Satu hasil berdasarkan id
    ...
    // Jika data po ditemukan lanjut ambil detail po berdasarkan id
...
<div class="d-flex justify-content-between align-items-center mb-4 d-print-none">
  <h1 class="fs-5 mb-4">Detail Purchase Order <?= $content_title ?></h1>
  <div>
    <a href="<?= base_url("pages/purchase-orders/$category_param") ?>" class="btn-act btn-back" title="Kembali"></a>
...
<div class="paper-wrapper p-5">
  <div class="row mb-2">
    ...
    <div class="col">
      <div class="row text-end">
        <p class="fs-1 mb-2">PURCHASE ORDER</p>
      ...
      <div class="row d-flex justify-content-end text-end pe-3">
  ...
  <div class="row mb-2">
    ...
    <p class="mb-0 text-justify">Bersamaan ini, kami mengajukan pesanan pembelian untuk produk/jasa yang tercantum di
      bawah ini.
    </p>
  </div>
  <?php endif; ?>
  ...
  <?php if ($category_param == 'outgoing') : ?>
  <div class="row mb-1">
    <p class="text-justify">Demikian pesanan pembelian dari Kami, mohon diproses dengan baik. Apabila terdapat
  ...
  <div class="row justify-content-end">
    <div class="col-auto text-center">
      ...
      <?php endif; ?>
      <p class="mb-0"><?= ucwords($signatureDetails['Name'] ?? '') ?></p>
      <p class="mb-0"><?= ucwords($signatureDetails['Position'] ?? '') ?></p>
      <?php else : ?>
      <p class="mb-0"><?= ucwords($signatureDetails['Name'] ?? '') ?></p>
      <p class="mb-0"><?= ucwords($signatureDetails['Position'] ?? '') ?></p>
      <?php endif; ?>
