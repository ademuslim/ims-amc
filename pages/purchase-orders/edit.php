          ...
          <div class="col-md-5 p-0">
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                ...
                <div class="invalid-feedback">
                  Sistem error, nomor pesanan gagal dimuat.
                </div>
              </div>
            </div>
            <div class="row mb-3">
...
$(document).ready(function() {
  ...
  $(document).on('click', '.remove-btn', function() {
    var idDetailPenawaran = $(this).closest('.main-tr').find('input[name="id_detail_pesanan[]"]').val();
  ...
  $(document).on('input', '.qty, .price', function() {
    ...
    var idDetailPenawaran = row.find('input[name="id_detail_pesanan[]"]').val(); // Dapatkan ID detail
