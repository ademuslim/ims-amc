...
if (isset($_POST['add'])) {
    ...
    if ($category_param === 'outgoing') {
        ...
        $data = selectData("penawaran_harga", "", "tanggal DESC", "1");
    ...
    $file_destination_logo = $file_destination_signature = "";
    ...
    if(isset($_FILES['logo']) && $_FILES['logo']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($_POST['reset_logo'] === 'true') {
            $file_destination_logo = null; // Logo kosong jika direset
        } else {
            $file_destination_logo = $defaultLogoPath ?: null;
        }
    }
    ...
    if(isset($_FILES['signature']) && $_FILES['signature']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($_POST['reset_signature'] === 'true') {
            $file_destination_signature = null; // Signature kosong jika direset
        } else {
            $file_destination_signature = $defaultSignaturePath ?: null;
        }
    }
